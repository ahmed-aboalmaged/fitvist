  ...
  return (
    <div style={{ minHeight: '100svh', display: 'flex', flexDirection: 'column', background: 'var(--bg)' }}>
      ...
      >
        ...
        <div
          className="animate-fade-in"
          style={{ marginTop: 28, display: 'flex', alignItems: 'center', gap: 8, padding: '8px 20px', border: '1px solid var(--border)', background: 'var(--bg-card)', borderRadius: 3, animationDelay: '0.3s' }}
        >
